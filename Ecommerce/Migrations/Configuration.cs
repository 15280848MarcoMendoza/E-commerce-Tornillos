namespace Ecommerce.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Ecommerce.Models.ApplicationDbContext>
    {
        ...
        private void SeedEmpleados(ApplicationDbContext db) {
            ...
            var user_pp = new ApplicationUser();
            user_pp.Email = "pagoaproveedores@gmail.com";
            user_pp.UserName = "Pago a Proveedores";
            var pp = userManager.Create(user_pp, "Pago a Proveedores");

            if (al.Succeeded)
            {

                userManager.AddToRoles(user_pp.Id, "Administrador", "Empleado");

                Empleados w_rh = new Empleados();
                w_rh.Id_users = user_pp.Id;
                w_rh.Nombre = "Brian Octavio Mora Anaya";
                w_rh.Sexo = true;
                w_rh.Salario = 5000;
                w_rh.Puesto = "Control Pago a Proveedores";
                w_rh.Area = "Pago a Proveedores";
                w_rh.Fecha_Nacimeinto = new DateTime(1995, 06, 16);
                w_rh.Estado = "Mexico";
                w_rh.Municipio = "Metepec";
                w_rh.CodigoPostal = 52789;
                w_rh.Colonia = "Metepec";
