    ...
    public class PagoProveedoresController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            if (User.Identity.IsAuthenticated) {
                ...
                if (user.Active && (user.Puesto.Equals("Control Pago Proveedores" ) || user.Puesto.Equals("Director Administrativo"))) {
        ...
        public ActionResult HistoriaI()
        {
            return View();
        }
        public ActionResult Ιndex()
        {
            return View();
        }
